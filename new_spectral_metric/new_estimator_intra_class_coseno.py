...
class SimilarityCalculator:  
    ...
    def cosine_similarity_blocked(self, data, block_size=200):  
        ...
        data_torch = torch.nn.functional.normalize(data_torch, p=2, dim=1)  # Normalize to unit vectors  
    ...
    def compute_intra_class_similarity(self, data, class_indices, block_size=200):  
        similarities = {}  
